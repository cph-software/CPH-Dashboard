...
class CreateMasterImportTokoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_import_toko', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('id_toko')->unique('id_toko');
            ...
            $table->bigInteger('limit_toko')->nullable();
    ...
    {
        Schema::dropIfExists('master_import_toko');
    }
}
