...
<html lang="en" class="layout-wide customizer-hide" dir="ltr" data-skin="default" data-bs-theme="light"
    data-assets-path="{{ asset('template/full-version/assets') }}/" data-template="vertical-menu-template">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('template/full-version/assets/img/favicon/favicon.ico') }}" />
...
<body>
    ...
    <script
        src="{{ asset('template/full-version/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
