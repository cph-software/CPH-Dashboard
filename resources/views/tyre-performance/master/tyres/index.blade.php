                        ...
                        <td>
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                 <a class="dropdown-item edit-tyre" href="javascript:void(0);" data-bs-toggle="modal"
                                    data-bs-target="#editTyreModal" data-id="{{ $tyre->id }}"
                                    data-serial="{{ $tyre->serial_number }}" data-brand-id="{{ $tyre->tyre_brand_id }}"
                                    data-size-id="{{ $tyre->tyre_size_id }}"
