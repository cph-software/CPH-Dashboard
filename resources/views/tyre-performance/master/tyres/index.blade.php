...
@section('content')
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title"><i class="ri-disc-line me-1 text-primary"></i> Add New Tyre</h5>
            ...
            <form action="{{ route('tyre-master.store') }}" method="POST">
               ...
               <div class="modal-body">
                  ...
                  {{-- Section Divider: Data Tambahan / Opsional --}}
                  <div class="divider my-4">
                     <div class="divider-text text-muted small text-uppercase fw-semibold">
                        <i class="ri-information-line me-1"></i> Informasi Tambahan (Opsional)
                     </div>
                  </div>

                  {{-- Data Opsional (Muted / Abu-abu) --}}
                  <div class="row g-3 mb-2">
                     <div class="col-md-6">
                        <label for="serial_number" class="form-label text-muted">Serial Number (SN) <small class="text-muted">(Opsional - Auto-Gen)</small></label>
                     ...
                     <div class="col-md-3">
                        <label for="custom_serial_number" class="form-label text-muted">Custom Code <small class="text-muted">(Opsional)</small></label>
                        <input type="text" id="custom_serial_number" name="custom_serial_number" class="form-control"
                           placeholder="Ex: BAN-01">
                     </div>
                     <div class="col-md-3">
                        <label for="add_quantity" class="form-label text-muted">Jumlah (Qty) <small class="text-muted">(Default: 1)</small></label>
                  ...
                  <div class="row g-3 mb-2">
                     <div class="col-md-6">
                        <label for="segment_name" class="form-label text-muted">Segment Name <small class="text-muted">(Opsional)</small></label>
                        <select id="segment_name" name="segment_name" class="form-select select2-tags-segment" data-placeholder="Ex: Mining, Hauling, dll.">
                     ...
                     <div class="col-md-6">
                        <label for="ply_rating" class="form-label text-muted">Ply Rating (PR) <small class="text-muted">(Opsional)</small></label>
                  ...
                  <div class="row g-3">
                     <div class="col-md-12">
                        <div class="form-check form-switch mt-1">
                           ...
                           <label class="form-check-label text-muted" for="is_in_warehouse">Simpan di Gudang / Stok Fisik Tersedia</label>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="modal fade" id="editTyreModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title"><i class="ri-edit-line me-1 text-warning"></i> Edit Tyre</h5>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editTyreForm" method="POST">
               ...
               <div class="modal-body">
                  ...
                  <div class="row g-3 mb-2">
                     <div class="col-md-7">
                        <label for="edit_serial_number" class="form-label text-muted">Serial Number (SN)</label>
                        <div class="input-group">
                     ...
                     <div class="col-md-5">
                        <label for="edit_custom_serial_number" class="form-label text-muted">Custom Code <small class="text-muted">(Opsional)</small></label>
                  ...
                  <div class="row g-3 mb-2">
                     <div class="col-md-6">
                        <label for="edit_segment_name" class="form-label text-muted">Segment Name <small class="text-muted">(Opsional)</small></label>
                     ...
                     <div class="col-md-6">
                        <label for="edit_ply_rating" class="form-label text-muted">Ply Rating <small class="text-muted">(Opsional)</small></label>
                  ...
                  <div class="row g-3">
                     <div class="col-md-12">
                        <div class="form-check form-switch mt-1">
                           ...
                           <label class="form-check-label text-muted" for="edit_is_in_warehouse">In Warehouse (Stok Fisik Tersedia)</label>
                        </div>
                     </div>
                  </div>
               </div>
