               ...
               <div class="card premium-card mb-4 border-start border-primary border-5">
                  <div class="card-body">
                     ...
                     <div class="row g-3 mb-4">
                        <div class="col-md-6">
                           <label class="form-label fw-bold text-primary">1. Posisi Sumber (Ban A)</label>
                        ...
                        <div class="col-md-6">
                           <label class="form-label fw-bold text-success">2. Posisi Tujuan (Ke Posisi B)</label>
                  ...
                  <div class="card-body">
                     ...
                     <div class="p-3 border rounded mb-3 bg-light">
                        ...
                        <div class="row g-3">
                           <div class="col-md-4">
                              ...
                              <input type="number" name="rtd_reading" id="rtd_reading" class="form-control"
                                 step="0.01" required>
                           </div>
                           <div class="col-md-4">
                     ...
                     <div id="swap_inspection" class="p-3 border rounded mb-3 bg-light border-warning"
                        ...
                        <div class="row g-3">
                           ...
                           <div class="col-md-4">
                              <label class="form-label fw-bold">Rim Size</label>
                              <input type="text" name="target_rim_size" id="target_rim_size" class="form-control">
                           </div>
                        </div>
                     </div>
                  </div>
