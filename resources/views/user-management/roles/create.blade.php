   ...
   <div class="container-xxl flex-grow-1 container-p-y">
      <div class="d-flex justify-content-between align-items-center mb-4">
         <div class="d-flex align-items-center">
            ...
            <div>
               <h4 class="mb-0 fw-bold">Add New Role</h4>
               <p class="mb-0 text-muted small">Create a new system role and assign permissions</p>
            </div>
         </div>
                  ...
                  <div class="card-body pt-4">
                     <div class="mb-3">
                        ...
                        <input type="text" id="roleName" name="name"
                           class="form-control @error('name') is-invalid @enderror" placeholder="Example: Supervisor Tyre"
                  ...
                  <div class="card-body">
                     <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg shadow-sm">
                           <i class="icon-base ri ri-save-line me-1"></i> Save New Role
                        </button>
