...
Route::middleware(['auth', 'eula'])->group(function () {
    // EULA Routes
    Route::get('/eula', [LoginController::class, 'showEula'])->name('eula.show');
    ...
    Route::get('tyre-dashboard/export-pdf', [\App\Http\Controllers\TyrePerformance\DashboardController::class, 'exportExecutivePdf'])->name('master_data.export_pdf')->middleware('tyre.permission:Dashboard');
    ...
    Route::post('master_company/{id}/mapping', [\App\Http\Controllers\TyrePerformance\Master\TyreCompanyController::class, 'updateMapping'])->name('tyre-companies.update-mapping')->middleware('tyre.permission:Master Instansi');
    ...
    Route::get('master_tyre/options-by-company', [\App\Http\Controllers\TyrePerformance\Master\TyreMasterController::class, 'getOptionsByCompany'])->name('tyre-master.options-by-company')->middleware('tyre.permission:Master Tyre');
    ...
    Route::get('master_kendaraan/{id}/layout', [\App\Http\Controllers\TyrePerformance\Movement\TyreMovementController::class, 'getVehicleLayout'])->middleware('tyre.permission:Vehicle Master');
    Route::resource('master_kendaraan', \App\Http\Controllers\TyrePerformance\Master\KendaraanController::class)->names('tyre-kendaraan')->except(['create', 'edit'])->middleware('tyre.permission:Vehicle Master');
    ...
    Route::get('get-warehouse-stock', [\App\Http\Controllers\TyrePerformance\Movement\TyreMovementController::class, 'getWarehouseStock'])->name('tyre-movement.warehouse-stock')->middleware('tyre.permission:Tyre Operations');
